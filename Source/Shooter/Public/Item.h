...
private:
    ...
    /** Индекс материала, который мы хотели бы изменить во время выполнения */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Item Properties", meta = (AllowPrivateAccess = "true"))
    int32 MaterialIndex;

    /** Динамический экземпляр, который мы можем изменить во время выполнения */
    UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Item Properties", meta = (AllowPrivateAccess = "true"))
    UMaterialInstanceDynamic* DynamicMaterialInstance;

    /** Экземпляр материала, используемый с экземпляром динамического материала */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Item Properties", meta = (AllowPrivateAccess = "true"))
...
public:
    ...
    // Установить значок предмета для инвентаря
    FORCEINLINE void SetIconItem(UTexture2D* Icon) { IconItem = Icon; }
    // Установите значок боеприпасов для виджета пикапа
